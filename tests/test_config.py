...
from python_lsp_mcp.config import Config, LSPServerConfig, create_default_config, load_config
...
class TestLSPServerConfig:
    ...
    def test_server_config_defaults(self):
        ...
        config = LSPServerConfig(
            id="test", command="test-lsp", extensions=[".py"], languages=["python"]
        )
...
class TestConfig:
    ...
    def test_config_creation(self):
        ...
        lsp_config = LSPServerConfig(
            id="pylsp", command="pylsp", extensions=[".py"], languages=["python"]
        )

        config = Config(lsps=[lsp_config], workspace=Path("/tmp"))
